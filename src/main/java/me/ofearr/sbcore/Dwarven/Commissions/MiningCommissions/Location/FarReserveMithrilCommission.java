...
public class FarReserveMithrilCommission implements DwarvenCommission {
    @Override
    public String commissionName() {
        return "Far Reserve Mithril";
    }

    @Override
    public String commissionID() {
        return "far_reserve_mithril";
    }
    ...
    public String description() {
        return "&7Mine &a" + requiredCountForCompletion() + "&7 Mithril in the Far Reserve.";
    }
