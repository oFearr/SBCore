...
public class RoyalMinesMithrilCommission implements DwarvenCommission {
    @Override
    public String commissionName() {
        return "Royal Mines Mithril";
    }

    @Override
    public String commissionID() {
        return "royal_mines_mithril";
    }
    ...
    public String description() {
        return "&7Mine &a" + requiredCountForCompletion() + "&7 Mithril in the Royal Mines.";
    }
