...
public class FrontLoadedUpgrade implements DwarvenUpgrade {
    @Override
    public String name() {
        return "Front Loaded";
    }
    ...
    public String description() {
        return "&7Grants &a+100 &6⸕ Mining Speed &7and\n&6☘ Bonus Fortune &7for the first\n&a{buff} &7ores you mine in a day.";
    }
