package me.ofearr.sbcore.Dwarven.Upgrades.Tier3Upgrades;
...
public class DailyPowderUpgrade implements DwarvenUpgrade {
    @Override
    public String name() {
        return "Daily Powder";
    }
    ...
    public String description() {
        return "&7Gain &a+{buff} ᠅ Powder &7from\n&7the first ore you mine every\n&7day. Works for all Powder Types.";
    }
