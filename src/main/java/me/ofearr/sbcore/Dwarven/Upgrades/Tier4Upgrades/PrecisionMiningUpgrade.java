package me.ofearr.sbcore.Dwarven.Upgrades.Tier4Upgrades;
...
public class PrecisionMiningUpgrade implements DwarvenUpgrade {
    @Override
    public String name() {
    ...
    public String description() {
        return "&7When mining ore, a particle\n&7target appears on the block\n&7that increases your\n&6⸕ Mining Speed &7by &a{buff}% &7when\n&7aiming at it.";
    }
