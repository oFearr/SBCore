...
public class DiamondCollection implements Collection {
    ...
    public void addDisplayItems(Player player) {
        ...
        for(int i = 1; i <= maxCollectionLevel(); i++){
            ...
            if(i == 1){
                levelLore.add(StringUtils.translate(" &9Diamond Minion &7Recipes"));

            } else if(i == 2){
                levelLore.add(StringUtils.translate(" &fEnchanted Book (Execute IV) &7Recipe"));

            } else if(i == 3){
                levelLore.add(StringUtils.translate(" &aEnchanted Diamond &7Recipe"));

            } else if(i == 4){
                levelLore.add(StringUtils.translate(" &7Access to &6/warp DeepCaverns"));

            } else if(i == 5){
                levelLore.add(StringUtils.translate(" &fEnchanted Book (Critical IV) &7Recipe"));

            } else if(i == 6){
                levelLore.add(StringUtils.translate(" &6Diamond Spreading &7Recipe"));

            } else if(i == 7){
                levelLore.add(StringUtils.translate(" &9Enchanted Diamond Block &7Recipe"));

            } else if(i == 8){
                levelLore.add(StringUtils.translate(" &9Perfect Helmet - Tier I &7Recipe"));
                levelLore.add(StringUtils.translate(" &9Perfect Chestplate - Tier I &7Recipe"));
                levelLore.add(StringUtils.translate(" &9Perfect Leggings - Tier I &7Recipe"));
                levelLore.add(StringUtils.translate(" &9Perfect Boots - Tier I &7Recipe"));
    ...
    public String getLevelPermissionReward(int collectionLevel) {
        ...
        if(collectionLevel == 1){
            return "sbcore.crafts.minion.diamond";

        } else if(collectionLevel == 2){
            return "sbcore.crafts.enchants.execute";

        } else if(collectionLevel == 3){
            return "sbcore.crafts.materials.enchanteddiamond";

        } else if(collectionLevel == 4){
            return "sbcore.warps.goldmine";

        } else if(collectionLevel == 5){
            return "sbcore.crafts.enchants.critical";

        } else if(collectionLevel == 6){
            return "sbcore.crafts.minions.upgrades.diamondspreading";

        } else if(collectionLevel == 7){
            return "sbcore.crafts.materials.enchanteddiamondblock";

        } else if(collectionLevel == 8){
            return "sbcore.crafts.armour.perfect";
