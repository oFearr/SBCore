...
public class LapisCollection implements Collection {
    ...
    public void addDisplayItems(Player player) {
        ...
        for(int i = 1; i <= maxCollectionLevel(); i++){
            ...
            if(i == 1){
                levelLore.add(StringUtils.translate(" &9Lapis Minion &7Recipes"));

            } else if(i == 2){
                levelLore.add(StringUtils.translate(" &fExperience Bottle &7Recipe"));

            } else if(i == 3){
                levelLore.add(StringUtils.translate(" &fEnchanted Book (Experience II) &7Recipe"));

            } else if(i == 4){
                levelLore.add(StringUtils.translate(" &aEnchanted Lapis &7Recipe"));

            } else if(i == 5){
                levelLore.add(StringUtils.translate(" &aGrand Experience Bottle &7Recipe"));

            } else if(i == 6){
                levelLore.add(StringUtils.translate(" &fExperience Potion &7Recipe"));

            } else if(i == 7){
                levelLore.add(StringUtils.translate(" &9Enchanted Lapis Block &7Recipe"));

            } else if(i == 8){
                levelLore.add(StringUtils.translate(" &9Titanic Experience Bottle &7Recipe"));

            } else if(i == 9){
                levelLore.add(StringUtils.translate(" &5Experience Artifact &7Recipe"));

            } else if(i == 10){
                levelLore.add(StringUtils.translate(" &6Textbook &7Recipe"));
    ...
    public String getLevelPermissionReward(int collectionLevel) {
        ...
        if(collectionLevel == 1){
            return "sbcore.crafts.minion.lapis";

        } else if(collectionLevel == 2){
            return "sbcore.crafts.misc.experiencebottle";

        } else if(collectionLevel == 3){
            return "sbcore.crafts.enchants.experience";

        } else if(collectionLevel == 4){
            return "sbcore.crafts.materials.enchantedlapis";

        } else if(collectionLevel == 5){
            return "sbcore.crafts.misc.grandexperiencebottle";

        } else if(collectionLevel == 6){
            return "sbcore.crafts.potions.experience";

        } else if(collectionLevel == 7){
            return "sbcore.crafts.materials.enchantedlapisblock";

        } else if(collectionLevel == 8){
            return "sbcore.crafts.misc.titanicexperiencebottle";

        } else if(collectionLevel == 9){
            return "sbcore.crafts.accessories.experienceartifact";

        } else if(collectionLevel == 10){
            return "sbcore.crafts.pets.items.textbook";
