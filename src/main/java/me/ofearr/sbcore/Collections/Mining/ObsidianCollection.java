...
public class ObsidianCollection implements Collection {
    ...
    public void addDisplayItems(Player player) {
        ...
        for(int i = 1; i <= maxCollectionLevel(); i++){
            ...
            if(i == 1){
                levelLore.add(StringUtils.translate(" &9Obsidian Minion &7Recipes"));

            } else if(i == 2){
                levelLore.add(StringUtils.translate(" &fEnchanted Book (Lethality IV) &7Recipe"));

            } else if(i == 3){
                levelLore.add(StringUtils.translate(" &aGravity Talisman &7Recipe"));

            } else if(i == 4){
                levelLore.add(StringUtils.translate(" &aEnchanted Obsidian &7Recipe"));

            } else if(i == 5){
                levelLore.add(StringUtils.translate(" &5Treecapitator &7Recipe"));

            } else if(i == 6){
                levelLore.add(StringUtils.translate(" &5Reforge Anvil &7Recipe"));
    ...
    public String getLevelPermissionReward(int collectionLevel) {
        ...
        if(collectionLevel == 1){
            return "sbcore.crafts.minion.obsidian";

        } else if(collectionLevel == 2){
            return "sbcore.crafts.enchants.lethality";

        } else if(collectionLevel == 3){
            return "sbcore.crafts.accessories.gravitytalisman";

        } else if(collectionLevel == 4){
            return "sbcore.crafts.materials.enchantedobsidian";

        } else if(collectionLevel == 5){
            return "sbcore.crafts.tools.treecapitator";

        } else if(collectionLevel == 6){
            return "sbcore.crafts.misc.reforgeanvil";
