...
public class GoldCollection implements Collection {
    ...
    public void addDisplayItems(Player player) {
        ...
        for(int i = 1; i <= maxCollectionLevel(); i++){
            ...
            if(i == 1){
                levelLore.add(StringUtils.translate(" &9Gold Minion &7Recipes"));

            } else if(i == 2){
                levelLore.add(StringUtils.translate(" &fEnchanted Book (Looting II) &7Recipe"));

            } else if(i == 3){
                levelLore.add(StringUtils.translate(" &aEnchanted Gold Ingot &7Recipe"));

            } else if(i == 4){
                levelLore.add(StringUtils.translate(" &fAbsorption Potion &7Recipe"));

            } else if(i == 5){
                levelLore.add(StringUtils.translate(" &fEnchanted Book (Looting II) &7Recipe"));

            } else if(i == 6){
                levelLore.add(StringUtils.translate(" &9Enchanted Gold Block &7Recipe"));

            } else if(i == 7){
                levelLore.add(StringUtils.translate(" &fEnchanted Book (Fortune II) &7Recipe"));
    ...
    public String getLevelPermissionReward(int collectionLevel) {
        ...
        if(collectionLevel == 1){
            return "sbcore.crafts.minion.gold";

        } else if(collectionLevel == 2){
            return "sbcore.crafts.enchants.looting";

        } else if(collectionLevel == 3){
            return "sbcore.crafts.materials.enchantedgoldingot";

        } else if(collectionLevel == 4){
            return "sbcore.crafts.potions.absorption";

        } else if(collectionLevel == 5){
            return "sbcore.crafts.enchants.scavenger";

        } else if(collectionLevel == 6){
            return "sbcore.crafts.materials.enchantedgoldblock";

        } else if(collectionLevel == 7){
            return "sbcore.crafts.enchants.fortune";
